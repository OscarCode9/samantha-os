  ...
  en: {
    translation: {
      ...
      docs: {
        ...
        quickstartIntro: 'Learn how to build and install the Vala wingpanel indicator (panel-sam) and the background Go runtime (claw) on your local machine or VM running elementary OS.',
        ...
        quickstartStep2Title: 'Step 2: Build & Run the Go Runtime Gateway',
  ...
  es: {
    translation: {
      ...
      docs: {
        ...
        quickstartIntro: 'Aprende a compilar e instalar el indicador de panel en Vala (panel-sam) y el motor de ejecución en Go (claw) en tu máquina local o máquina virtual con elementary OS.',
        ...
        quickstartStep2Title: 'Paso 2: Compilar y Ejecutar el Gateway en Go',
